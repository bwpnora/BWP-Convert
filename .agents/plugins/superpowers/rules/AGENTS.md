...
**Below is the full content of your 'superpowers:using-superpowers' skill - your introduction to using skills. For all other skills, use view_file to read its SKILL.md:**
...
## Antigravity Platform Adaptation
